...
export default function ControlPanel() {
  ...
  const pipelineData = [
  {
    ...
    start: "4/18/2023, 8:30:00 AM",
    end: "4/18/2023, 8:45:00 AM",
    status: "Success",
  },
  {
    name: "Financial Data Tokenization",
    start: "4/15/2023, 5:10:00 AM",
    end: "4/15/2023, 5:30:00 AM",
    status: "Success",
  },
  {
    name: "Employee Data Protection",
    start: "4/20/2023, 10:15:00 AM",
    end: "-",
    status: "Running",
  },
  {
    name: "Marketing Data Synthesis",
    start: "4/19/2023, 7:05:00 AM",
    end: "4/19/2023, 7:25:00 AM",
    status: "Failed",
  },
];
  ...
  const [pipelines, setPipelines] = useState([
    {
      ...
      endTime: "2023-04-18T12:45:00Z",
      status: "success",
      message: "Pipeline completed successfully. 1,245 records processed.",
      sourceDb: "Customer Database (Production)",
      destinationDb: "Analytics Data Warehouse",
      techniques: ["anonymization", "masking"]
    },
    {
      id: 2,
      name: "Financial Data Tokenization",
      startTime: "2023-04-15T09:10:00Z",
      endTime: "2023-04-15T09:30:00Z",
      status: "success",
      message: "Pipeline completed successfully. 892 records processed.",
      sourceDb: "Financial Records (Production)",
      destinationDb: "Analytics Data Warehouse",
    ...
    },
    {
      id: 3,
      name: "Employee Data Protection",
      startTime: "2023-04-20T14:15:00Z",
      status: "running",
      message: "Pipeline processing... 65% complete",
      sourceDb: "HR Database (Production)",
      destinationDb: "Secure Analytics Storage",
      techniques: ["anonymization", "generate"]
    },
    {
      id: 4,
      name: "Sales Data Masking",
      startTime: "2023-04-19T16:20:00Z",
      status: "failed",
      message: "Connection timeout to source database",
      sourceDb: "Sales Database (Production)",
      destinationDb: "Test Environment",
      techniques: ["masking"]
    }
  ]);
  ...
  const handleViewPipeline = (pipeline) => {
    toast({
      ...
      description: `Viewing details for ${pipeline.name}`,
    });
  };
  ...
  const handleDeletePipeline = (pipeline) => {
    ...
    toast({
      ...
      description: `${pipeline.name} has been removed from the system.`,
    });
  };
  ...
  const handleRetryPipeline = (pipeline) => {
    const updatedPipeline = {
      ...pipeline,
      status: "running",
      message: "Retrying pipeline execution...",
    ...
    toast({
      ...
      description: `${pipeline.name} is now running again.`,
    });
  };
      ...
      >
        <CardHeader className="pb-2">
          <CardTitle className="text-[#2196F3] text-base font-medium flex justify-between items-center">
            {title}
            {/* Optional: Add icons here if needed */}
            {/* {idx === 0 && <Terminal className="h-4 w-4" />}
            {idx === 1 && <Settings className="h-4 w-4" />}
  ...
  <Card className="rounded-xl shadow-sm border border-gray-200">
    <CardHeader className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <Button size="sm" variant="outline" className="flex items-center gap-1 text-[#2196F3] border-[#2196F3]">
